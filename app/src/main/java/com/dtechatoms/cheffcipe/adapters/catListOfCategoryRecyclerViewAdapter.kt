 ...
 */
class catListOfCategoryRecyclerViewAdapter(val clickListener: CategoryClickListener) :
    ListAdapter<CategoryModel, catListOfCategoryRecyclerViewAdapter.CategoryViewHolder>(
        DiffCallBack
    ) {
